...
(custom-set-faces
 ...
 '(rst-level-1 ((t (:background "grey15" :height 1.6))))
 '(rst-level-1-face ((t (:foreground "LightSkyBlue"))) t)
 '(rst-level-2 ((t (:background "grey15" :height 1.4))))
 '(rst-level-2-face ((t (:foreground "LightGoldenrod"))) t)
 '(rst-level-3 ((t (:background "grey15" :height 1.2))))
 '(rst-level-3-face ((t (:foreground "Cyan1"))) t)
 '(rst-level-4 ((t (:background "grey15" :height 1.2))))
 '(rst-level-4-face ((t (:foreground "chocolate1"))) t)
 '(rst-level-5 ((t (:background "grey15" :height 1.2))))
 '(rst-level-5-face ((t (:foreground "PaleGreen"))) t)
 '(rst-level-6 ((t (:background "grey15" :height 1.2))))
